                                ...
                                <table class="table tablex">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <input type="number" class="form-control form-control-sm me-1" placeholder="Dari" value="2010">
                                                    <input type="number" class="form-control form-control-sm" placeholder="Sampai" value="2015">
                                                </div>
                                            </td>
                                            <td>751</td>
                                            <td>Scopus</td>
